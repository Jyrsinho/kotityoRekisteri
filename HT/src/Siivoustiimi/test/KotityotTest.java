 ...
 * @version 2024.04.18 20:15:56 // Generated by ComTest
 *
 */
...
public class KotityotTest {
   ...
   */
  @Test
  public void testLueTiedostosta138() throws SailoException {    // Kotityot: 138
    Kotityot kotityot = new Kotityot(); 
    Kotityo imurointi21 = new Kotityo(); imurointi21.taytaKotityo(2); 
    Kotityo imurointi11 = new Kotityo(); imurointi11.taytaKotityo(1); 
    Kotityo imurointi22 = new Kotityo(); imurointi22.taytaKotityo(2); 
    ...
    fail("Kotityot: 151 Did not throw SailoException");
    ...
    assertEquals("From: Kotityot line: 165", imurointi21.toString(), i.next().toString()); 
    assertEquals("From: Kotityot line: 166", imurointi11.toString(), i.next().toString()); 
    assertEquals("From: Kotityot line: 167", imurointi22.toString(), i.next().toString()); 
    assertEquals("From: Kotityot line: 168", imurointi12.toString(), i.next().toString()); 
    assertEquals("From: Kotityot line: 169", imurointi23.toString(), i.next().toString()); 
    assertEquals("From: Kotityot line: 170", false, i.hasNext()); 
    kotityot.lisaa(imurointi23); 
    try {
    kotityot.tallenna(); 
    } catch (IOException e) {
    ...
    assertEquals("From: Kotityot line: 177", true, ftied.delete()); 
    File fbak = new File(tiedNimi+".bak"); 
    assertEquals("From: Kotityot line: 179", true, fbak.delete()); 
  } // Generated by ComTest END
  ...
  /** testIterator312 */
  @Test
  public void testIterator312() {    // Kotityot: 312
    Kotityot kotityot = new Kotityot(); 
    ...
    assertEquals("From: Kotityot line: 324", imurointi1, i2.next()); 
    assertEquals("From: Kotityot line: 325", imurointi2, i2.next()); 
    assertEquals("From: Kotityot line: 326", imurointi3, i2.next()); 
    assertEquals("From: Kotityot line: 327", imurointi4, i2.next()); 
    assertEquals("From: Kotityot line: 328", lakaisu, i2.next()); 
    try {
    assertEquals("From: Kotityot line: 329", lakaisu, i2.next()); 
    fail("Kotityot: 329 Did not throw NoSuchElementException");
  ...
  /** testAnnaKotityot343 */
  @Test
  public void testAnnaKotityot343() {    // Kotityot: 343
    Kotityot kotityot = new Kotityot(); 
    Kotityo imurointi1 = new Kotityo(2); kotityot.lisaa(imurointi1); 
    Kotityo imurointi2 = new Kotityo(1); kotityot.lisaa(imurointi2); 
    Kotityo imurointi3 = new Kotityo(2); kotityot.lisaa(imurointi3); 
    ...
    assertEquals("From: Kotityot line: 355", 0, loytyneet.size()); 
    loytyneet = kotityot.annaKotityot(1); 
    assertEquals("From: Kotityot line: 357", 1, loytyneet.size()); 
    loytyneet = kotityot.annaKotityot(2); 
    assertEquals("From: Kotityot line: 359", 4, loytyneet.size()); 
    assertEquals("From: Kotityot line: 360", true, loytyneet.get(0) == imurointi1); 
    assertEquals("From: Kotityot line: 361", true, loytyneet.get(1) == imurointi3); 
    loytyneet = kotityot.annaKotityot(2); 
    assertEquals("From: Kotityot line: 363", 4, loytyneet.size()); 
  } // Generated by ComTest END
}